...
namespace Practice_Linq
{
    public class Program
    {
        ...
        static void Query3(List<FootballGame> games)
        {
            ...
            var selectedGames = from game in games
                                where game.Date.Year == 2021
                                where game.Country == "France" && game.Home_team == "France"
        ...
        static void Query4(List<FootballGame> games)
        {
            ...
            var selectedGames = from game in games
                                ...
                                where game.Away_team == "Germany"
                                where game.Away_score < game.Home_score
                                select game;
        ...
        static void Query5(List<FootballGame> games)
        {
            ...
            var selectedGames = from game in games
                                where game.Tournament == "UEFA Euro qualification"
        ...
        static void Query9(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                   ...
                   .Select(game => new
                   {
                       ...
                       Result = GetResultForFirstTeam(game)
                   });
        ...
        private static string GetResultForFirstTeam(FootballGame game)
        {
